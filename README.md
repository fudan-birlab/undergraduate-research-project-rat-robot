# 本科生科研项目：小鼠/大鼠仿生机器人学习资料

本仓库用于整理本科生科研项目的学习方向、资料与后续补充内容，方便团队成员直接在 GitHub 上查看、添加和修改。
...
说明：原始压缩包 `Archive.zip` 本身不上传；其解压后的资料文件已上传到 `materials/Archive/`。

## 后续维护建议

- 新增资料可以放在 `materials/` 目录。
- 新增学习笔记可以直接添加 Markdown 文件。
- 如果方向或任务有更新，可以直接修改本 README。
